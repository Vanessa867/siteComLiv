      ...
      <Container maxWidth="lg" className="main-container">
        ...
        <Box id="como-funciona" className="new-section">
          ...
          <Typography variant="body1" className="new-section-description" paragraph>
            Aqui, você pode se juntar a grupos que discutem desde os livros que você ama até aqueles que provocam debates acalorados.
          </Typography>
        ...
        <Box className="benefits-section">
          ...
          <Box className="benefits-list">
            <Box className="benefit-item">
              <Typography variant="h3" className="benefit-number">1</Typography>
              <Box className="benefit-content">
                ...
                <Typography variant="body2" className="benefit-description">
                  A leitura é uma porta de entrada para o conhecimento, oferecendo insights sobre temas diversos e ampliando a compreensão do mundo.
                </Typography>
              </Box>
            </Box>
            <Box className="benefit-item">
              <Typography variant="h3" className="benefit-number">2</Typography>
              <Box className="benefit-content">
                <Typography variant="h6" className="benefit-title">
                  Aprimora a Empatia e a Inteligência Emocional
                </Typography>
                <Typography variant="body2" className="benefit-description">
                  Ao vivenciar diferentes histórias e perspectivas, os leitores podem entender melhor os dilemas e os conflitos alheios, fortalecendo sua empatia.
                </Typography>
              </Box>
            </Box>
            <Box className="benefit-item">
              <Typography variant="h3" className="benefit-number">3</Typography>
              <Box className="benefit-content">
                <Typography variant="h6" className="benefit-title">
                  Reduz o Estresse e Melhora o Bem-Estar Mental
                </Typography>
                <Typography variant="body2" className="benefit-description">
                  A leitura é uma forma eficaz de relaxamento, ajudando a aliviar o estresse e promovendo uma sensação de calma e tranquilidade.
                </Typography>
              </Box>
            </Box>
          </Box>
          ...
          <Box className="community-content">
            ...
            <Box className="community-text">
              ...
              <Typography variant="body1" className="community-description">
                Ler em comunidade ou em clubes permite que os leitores compartilhem suas impressões e entendimentos sobre um livro, o que enriquece a experiência de leitura. Cada pessoa traz vivências e pontos de vista únicos, o que abre portas para interpretações diversas e novas reflexões sobre a obra, criando um aprendizado coletivo e único.
              </Typography>
            </Box>
          </Box>
        </Box>
